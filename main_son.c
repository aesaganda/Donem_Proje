...
// Kullan�lan de�i�kenler
int kartNo[100];
int fisIslemSayaci = 0;
float karttakiPara[100];
float kasadakiPara = 1000; // test ama�l� 1000 de�eri
...
struct musteriBilgileri
{
    ...
    char *kartNumarasi;
    char *gecerlilikTarihi; // tarih ay/y�l seklinde
    char *kartSahibiAdi;
    char *guvenlikKodu;
...
// Ekleme ve G�ncelleme Fonksiyonlar�i
...
// test tipinde de�i�ken olu�turulmas�
...
void icecekSecimVeFiyatlandirma(struct menuBilgi *ptrYemek_Menu, int n)
{
    ...
    case 0:
        ...
        if (tercih)
        {
            //!Buraya ekstradan fis sonlandirma kismi eklenmeli ya da bu k�s�m kald�r�lmal�
    ...
    case 1:
        ...
        //TODO: toplamTutar sifirlanmadan once dosyaya aktarilmali
        //! fis yazd�rma isleminde icecek ile fisin sonlanacag� if ile d�zenlenmeli
        toplamTutar = 0;
        break;
...
void siparisDetaylari(float *fiyatToplam, float tekFiyat, char isim[], int fisIslemSayaci)
{
    ...
    *fiyatToplam += istenenSayi * tekFiyat;
    ...
    if (fisIslemSayaci == 0) // TODO: 0 bilgisi yani ilk siparis verilince yeni dosya acilacak fis tasar�m� baslayacak //cerceve vs
    {
    ...
    if (fisIslemSayaci == 3) //TODO: 3 bilgisi yani son siparis verildigi ve mevcut dosyanin kapatilmasi ve fis bitme tasar�m� //cerceve vs
    {
...
//Gerekli if yerlerinde kullan�lmak uzere secim icin fonksiyon
int secimFonksiyonu()
{
    int secim;
    echo("==> ");
