...
void fiyat_guncelle();
void musteriEkleme(musteriBilgileri *musteri);
...
void admin_menu();
void siparis_menu();
void ana_menu(musteriBilgileri *musteri);
void musteriGirisi(musteriBilgileri *musteri);
...
void musteriGirisi(musteriBilgileri *ptr)
{
    cls();
...
void musteriEkleme(musterilerPtr *musteri)
{
    system("color 3E");
    printf("\n\t\t");
    system("color 3E");
