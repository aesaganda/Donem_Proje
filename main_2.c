...
//int musteriSorgu(struct musteriBilgileri  ,int );
...
void musteriGiris(struct musteriBilgileri musteriEkleme[])
{
    system("color 2E");
    printf("\n\t\t");
    system("color 3E");
   ...
   // struct musteriBilgileri musteriEkleme[musteriSayisi];
    ...
    int id,n=0,i;
    char sifre[30];
    printf("\t\t\tLutfen size ozel ID kodunuzu giriniz:");
    scanf("%d",&id);
    ...
    {
        if(musteriEkleme[i].musteriId==0)
        {
             if(strcmp( musteriEkleme[i].musteriSifre,sifre)==0 && musteriEkleme[i].musteriId==sifre)
            {
            ...
            {
                printf("\t\t\tHatali giris yaptiniz....ana menuya yonlendiriliyorsunuz...");
                ana_menu();
            }
        }
    }
...
int musteriSorgu(struct musteriBilgileri musteriEkleme[] ,int ID)
{
    int i;
    for(i=0;i<musteriSayisi;i++)
    {
        if(musteriEkleme[i].musteriId==ID)
        {
            return ID;
        }
    }

    return -1;//bu id daha once hic kullanilmadi..
}
...
void musteriEkleme()
{
    ...
    int kayitYapilacakIndex=0,ID=0;
    srand(time(0));
    ...
    ID=rand()%100000+1;
    if(musteriSorgu(musteriEkleme,ID)!=-1)
    {
        printf("bu ID degeri daha once kullanilmistir...Kayit yapilamiyor...\n");
        exit(1);
    }
    //kisiye ozel ıd verildi...
        printf("\t\t\tID numaraniz  %d olarak belirlenmisti. \n",ID);
        musteriEkleme[kayitYapilacakIndex].musteriId=ID;
        ...
        musteriEkleme[kayitYapilacakIndex].musteriIsmi = (char *)malloc(sizeof(char) * strlen(musteriIsmi));
        musteriEkleme[kayitYapilacakIndex].musteriSoyismi = (char *)malloc(sizeof(char) * strlen(musteriSoyismi));
        musteriEkleme[kayitYapilacakIndex].musteriSifre = (char *)malloc(sizeof(char) * strlen(musteriSifre));
        kredikart[kayitYapilacakIndex].kartNumarasi = (char *)malloc(sizeof(char) * strlen(kartNumarasi));
        kredikart[kayitYapilacakIndex].kartSahibiAdi = (char *)malloc(sizeof(char) * strlen(kartSahibiAdi));
        kredikart[kayitYapilacakIndex].gecerlilikTarihi = (char *)malloc(sizeof(char) * strlen(gecerlilikTarihi));
        kredikart[kayitYapilacakIndex].guvenlikKodu = (char *)malloc(sizeof(char) * strlen(guvenlikKodu));
        adres[kayitYapilacakIndex].sehir = (char *)malloc(sizeof(char) * strlen(sehir));
        adres[kayitYapilacakIndex].ilce = (char *)malloc(sizeof(char) * strlen(ilce));
        adres[kayitYapilacakIndex].semt = (char *)malloc(sizeof(char) * strlen(semt));
        adres[kayitYapilacakIndex].sokak = (char *)malloc(sizeof(char) * strlen(sokak));
        adres[kayitYapilacakIndex].daireNo = (char *)malloc(sizeof(char) * strlen(daireNo));

        //!burada alinan bilgiler structlara kopyalandi...
        strcpy(musteriEkleme[kayitYapilacakIndex].musteriIsmi, musteriIsmi);
        strcpy(musteriEkleme[kayitYapilacakIndex].musteriSoyismi, musteriSoyismi);
        strcpy(musteriEkleme[kayitYapilacakIndex].musteriSifre, musteriSifre);
        strcpy(kredikart[kayitYapilacakIndex].kartNumarasi, kartNumarasi);
        strcpy(kredikart[kayitYapilacakIndex].kartSahibiAdi, kartSahibiAdi);
        strcpy(kredikart[kayitYapilacakIndex].gecerlilikTarihi, gecerlilikTarihi);
        strcpy(kredikart[kayitYapilacakIndex].guvenlikKodu, guvenlikKodu);
        strcpy(adres[kayitYapilacakIndex].sehir, sehir);
        strcpy(adres[kayitYapilacakIndex].ilce, ilce);
        strcpy(adres[kayitYapilacakIndex].semt, semt);
        strcpy(adres[kayitYapilacakIndex].sokak, sokak);
        strcpy(adres[kayitYapilacakIndex].daireNo, daireNo);

        //!Dosyaya yazdirma islemleri yapildi.
        fprintf(musteriKayitlari, "-Ad: %s\t-Soyad: %s\t-Sifre: %s\n", musteriEkleme[kayitYapilacakIndex].musteriIsmi,
                musteriEkleme[kayitYapilacakIndex].musteriSoyismi,musteriEkleme[kayitYapilacakIndex].musteriSifre);
        fprintf(musteriKayitlari,"-Kisiye ozel ID numaraniz :%d\n",musteriEkleme[kayitYapilacakIndex].musteriId);
        fprintf(musteriKayitlari, "-Kart Numarasi: %s\t-Kart Uzerindeki Isim: %s\n", kredikart[kayitYapilacakIndex].kartNumarasi,
                kredikart[kayitYapilacakIndex].kartSahibiAdi);
        fprintf(musteriKayitlari, "-Gecerlilik Tarihi: %s\t-Guvenlik Kodu: %s\n", kredikart[kayitYapilacakIndex].gecerlilikTarihi,
                kredikart[kayitYapilacakIndex].guvenlikKodu);
        fprintf(musteriKayitlari, "-Sehir: %s\t%-Ilce: %s\t-Mahalle: %s\n", adres[kayitYapilacakIndex].sehir, adres[kayitYapilacakIndex].ilce,
                adres[kayitYapilacakIndex].semt);
        fprintf(musteriKayitlari, "-Sokak: %s\t-Ev No: %s\n", adres[kayitYapilacakIndex].sokak, adres[kayitYapilacakIndex].daireNo);
