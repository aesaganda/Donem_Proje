...
void donerSecimVeFiyatlandirma(struct menuBilgi *ptrYemek_Menu, int n, struct menuBilgi *x);

void hamburgerSecimVeFiyatlandirma(struct menuBilgi *ptrYemek_Menu, int n, struct menuBilgi *x);

void corbaSecimVeFiyatlandirma(struct menuBilgi *ptrYemek_Menu, int n, struct menuBilgi *x);

void evYemekleriSecimVeFiyatlandirma(struct menuBilgi *ptrYemek_Menu, int n, struct menuBilgi *x);

void pizzaSecimVeFiyatlandirma(struct menuBilgi *ptrYemek_Menu, int n, struct menuBilgi *x);

void pideSecimVeFiyatlandirma(struct menuBilgi *ptrYemek_Menu, int n, struct menuBilgi *x);

void balikSecimVeFiyatlandirma(struct menuBilgi *ptrYemek_Menu, int n, struct menuBilgi *x);

void salataSecimVeFiyatlandirma(struct menuBilgi *ptrYemek_Menu, int n, struct menuBilgi *x);

void tatliSecimVeFiyatlandirma(struct menuBilgi *ptrYemek_Menu, int n, struct menuBilgi *x);

void icecekSecimVeFiyatlandirma(struct menuBilgi *ptrYemek_Menu, int n, struct menuBilgi *x);

//?
//!
void kebapBilgisiCek(struct menuBilgi *x);
void kebapBilgileriListele(struct menuBilgi *x);
...
void kebapBilgileriListele(struct menuBilgi *x)
{
    ...
    for (i = 0; i <= satirSayac; ++i)
        printf("%s %d %f \n", (x + i)->kebap.adi, (x + i)->kebap.malzemeAdedi, (x + i)->kebap.fiyati);
...
int main()
{
    ...
    ptrYemek_Menu = (struct menuBilgi *)malloc(1 * sizeof(struct menuBilgi));
...
void icecekler(int n, struct menuBilgi *x)
{
    ...
    {
        icecekSecimVeFiyatlandirma(ptrYemek_Menu, n, x);
    }
}
...
{
    int i, kebapCesitSayisi = 3, satirSayac = 0;
    char c;
...
void doner(int n, struct menuBilgi *x)
{
    ...
    {
        donerSecimVeFiyatlandirma(ptrYemek_Menu, n, x);
    }
}
...
void hamburger(int n, struct menuBilgi *x)
{
    ...
    {
        hamburgerSecimVeFiyatlandirma(ptrYemek_Menu, n, x);
    }
}
...
void corba(int n, struct menuBilgi *x)
{
    ...
    {
        corbaSecimVeFiyatlandirma(ptrYemek_Menu, n, x);
    }
}
...
void evYemekleri(int n, struct menuBilgi *x)
{
    ...
    {
        evYemekleriSecimVeFiyatlandirma(ptrYemek_Menu, n, x);
    }
}
...
void pizza(int n, struct menuBilgi *x)
{
    ...
    {
        pizzaSecimVeFiyatlandirma(ptrYemek_Menu, n, x);
    }
}
...
void pide(int n, struct menuBilgi *x)
{
    ...
    {
        pideSecimVeFiyatlandirma(ptrYemek_Menu, n, x);
    }
}
...
void balik(int n, struct menuBilgi *x)
{
    ...
    {
        balikSecimVeFiyatlandirma(ptrYemek_Menu, n, x);
    }
}
...
void salata(int n, struct menuBilgi *x)
{
    ...
    {
        salataSecimVeFiyatlandirma(ptrYemek_Menu, n, x);
    }
}
...
void tatli(int n, struct menuBilgi *x)
{
    ...
    {
        tatliSecimVeFiyatlandirma(ptrYemek_Menu, n, x);
    }
}
